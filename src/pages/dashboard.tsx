...
const metrics: SummaryMetric[] = [
  { title: "Total Users", value: "24,521", change: "+12% this month", positive: true },
  { title: "Revenue", value: "$84,200", change: "+8% this month", positive: true },
  { title: "Bounce Rate", value: "42%", change: "-3% this month", positive: false },
  { title: "Active Sessions", value: "1,340", change: "+5% this month", positive: true },
];

const Dashboard = () => {

  const [selectedFilter, setSelectedFilter] = useState<string>("All");
  const filteredData : TableRow[] = selectedFilter === "All" ?
   tableData
